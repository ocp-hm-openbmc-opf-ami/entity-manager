...
using DBusInterface = std::map<std::string, DBusValueVariant>;
using DBusObject = std::map<std::string, DBusInterface>;
using MapperGetSubTreeResponse = std::map<std::string, DBusObject>;
